//
//  ArchivedChatsMenuContext.swift
//  Swift_UIKit_ChatApp
//
...
extension ArchivedChatsVC {
    ...
    func tableView(_ tableView: UITableView, contextMenuConfigurationForRowAt indexPath: IndexPath, point: CGPoint) -> UIContextMenuConfiguration? {
        ...
        let row = self.archivedChatrooms[indexPath.row]
    
        
        let unarchiveOption : UIAction = {
            let title = Language.unarchive
            let option = UIAction(
                title: title,
        ...
        let menu = UIMenu(title: "", children: [unarchiveOption,readUnReadOption, pinUnpinOption, muteUnMuteOption, DeleteExitGroupOption])
     ...
     func tableView(_ tableView: UITableView, willPerformPreviewActionForMenuWith configuration: UIContextMenuConfiguration, animator: UIContextMenuInteractionCommitAnimating) {
         ...
         guard let chatroom = archivedChatrooms.item(for: configuration) else {
             return
         }
