...
//                    menuCell.menuButton.highlightedColor = .white.withAlphaComponent(1)
                    menuCell.menuButton.highlightedColor = .white.withAlphaComponent(0.2)
//                    menuCell.menuButton.unhighlightedColor = .systemGray5.withAlphaComponent(0.4)
//                    menuCell.menuButton.backgroundColor = .systemGray5.withAlphaComponent(0.4)
//                    menuCell.menuButton.unhighlightedColor = .systemBackground.withAlphaComponent(0.8)
//                    menuCell.menuButton.backgroundColor = .systemBackground.withAlphaComponent(0.8)
//
//                    switch menuCell.actionItems.attributes {
//                        case .destructive:
//                        menuCell.labelView.textColor = .systemRed
//                        menuCell.imageView.tintColor = .systemRed
//                        default:
//                        menuCell.labelView.textColor = .label
//                        menuCell.imageView.tintColor = .label
//                    }
                }
                print("now its dark")
            } else {
...
//                    menuCell.menuButton.unhighlightedColor = .systemBackground.withAlphaComponent(0.5)
//                    menuCell.menuButton.backgroundColor = .systemBackground.withAlphaComponent(0.5)
//
//                    switch menuCell.actionItems.attributes {
//                        case .destructive:
//                        menuCell.labelView.textColor = .systemRed
